...
```{r}
library(gbm)
boosting.fit = gbm(whrswk~., data=train.data, distribution = "gaussian" , n.trees=5, shrinkage=0.01, interaction.depth = 4)
...
Ahora aplicaremos validación cruzada con Boosting.
...
#### BOOSTING CON CARET
Ahora usaremos la libreria **caret** para tunear los párametros al modelo de BOOSTING
```{r}
library(caret)
set.seed(seed)
